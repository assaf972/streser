...
- `strester/report-YYYYMMDD-HHMMSS.txt` — human-readable with icons, tables, and ASCII bars
- `strester/report-YYYYMMDD-HHMMSS.json` — machine-readable structured data
...
# 5. Copy for review
cat perf/results/Labguru-v6.42.0/strester/report-*.txt | pbcopy
```
...
diff perf/results/Labguru-v6.41.0/strester/report-*.json \
     perf/results/Labguru-v6.42.0/strester/report-*.json
```
